...
module.exports={
  description:'ISV',
  excludePattern: [
    'iTalentSDKServer-0.1.9-51',
    'favicon.ico',
    'react-16.8.3.production',
    'main-1a5dc0f166a1c3d37239.min.css'
  ],
  includePattern: ['p-isv-devcenter'],
  localServerHostName: 'http://10.99.28.157:3000',
  port: 6789,
